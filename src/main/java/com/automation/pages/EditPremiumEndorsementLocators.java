...
/**
 * Locators for Edit Premium Endorsement Page
 * Mirrors CreatePremiumEndorsementLocators with "edit-endorsement" prefix
 * Extends CreateQuotePage to reuse addLocation functionality
 */
public class EditPremiumEndorsementLocators extends CreateQuotePage {

	// Element ID prefix for Edit Premium Endorsement
	protected static final String ELEMENT_PREFIX = "edit-endorsement";

	// ==================== Page Header Elements ====================

	@FindBy(xpath = "//h1[contains(text(),'Edit Premium Endorsement')]")
	protected WebElement pageTitle;

	// ==================== Agent Section Locators ====================

	@FindBy(id = "edit-endorsement-agent-select")
	protected WebElement agentDropdown;

	@FindBy(id = "edit-endorsement-agent-commission-input")
	protected WebElement agentCommissionInput;

	@FindBy(id = "edit-endorsement-agent-renewal-commission-input")
	protected WebElement agentRenewalCommissionInput;

	// ==================== Insured Section Locators ====================

	@FindBy(id = "edit-endorsement-insured-select")
	protected WebElement insuredDropdown;

	// ==================== Aggregator Section Locators ====================

	@FindBy(id = "edit-endorsement-aggregator-select")
	protected WebElement aggregatorDropdown;

	@FindBy(id = "edit-endorsement-aggregator-commission-input")
	protected WebElement aggregatorCommissionInput;

	@FindBy(id = "edit-endorsement-aggregator-renewal-commission-input")
	protected WebElement aggregatorRenewalCommissionInput;

	// ==================== Internal Agent Section Locators ====================

	@FindBy(id = "edit-endorsement-internal-agent-select")
	protected WebElement internalAgentDropdown;

	@FindBy(id = "edit-endorsement-internal-agent-commission-input")
	protected WebElement internalAgentCommissionInput;

	@FindBy(id = "edit-endorsement-internal-agent-renewal-commission-input")
	protected WebElement internalAgentRenewalCommissionInput;

	// ==================== User Section Locators ====================

	@FindBy(id = "edit-endorsement-user-select")
	protected WebElement userDropdown;

	// ==================== Date Section Locators ====================

	@FindBy(id = "edit-endorsement-effective-date-picker")
	protected WebElement effectiveDatePicker;

	@FindBy(id = "edit-endorsement-expiration-date-picker")
	protected WebElement expirationDatePicker;

	@FindBy(id = "edit-endorsement-endorsement-effective-date-picker")
	protected WebElement endorsementEffectiveDatePicker;

	// ==================== Carrier Section Locators ====================

	@FindBy(id = "edit-endorsement-carrier-select")
	protected WebElement carrierDropdown;

	// ==================== General Liability Section Locators ====================

	@FindBy(id = "edit-endorsement-general-liability-yes-radio")
	protected WebElement generalLiabilityYesRadio;

	@FindBy(id = "edit-endorsement-general-liability-no-radio")
	protected WebElement generalLiabilityNoRadio;

	@FindBy(id = "edit-endorsement-general-liability-amount-input")
	protected WebElement generalLiabilityAmountInput;

	@FindBy(id = "edit-endorsement-general-liability-apply-button")
	protected WebElement generalLiabilityApplyButton;

	// ==================== Water & Sewer Backup Section Locators ====================

	@FindBy(id = "edit-endorsement-water-sewer-backup-yes-radio")
	protected WebElement waterSewerBackupYesRadio;

	@FindBy(id = "edit-endorsement-water-sewer-backup-no-radio")
	protected WebElement waterSewerBackupNoRadio;

	@FindBy(id = "edit-endorsement-water-sewer-backup-amount-input")
	protected WebElement waterSewerBackupAmountInput;

	@FindBy(id = "edit-endorsement-water-sewer-backup-apply-button")
	protected WebElement waterSewerBackupApplyButton;

	// ==================== Animal Liability Section Locators ====================

	@FindBy(id = "edit-endorsement-animal-liability-25000-radio")
	protected WebElement animalLiability25000Radio;

	@FindBy(id = "edit-endorsement-animal-liability-no-radio")
	protected WebElement animalLiabilityNoRadio;

	@FindBy(id = "edit-endorsement-animal-liability-no-radio-alt")
	protected WebElement animalLiabilityNoRadioAlt;

	// ==================== Policy Fee Section Locators ====================

	@FindBy(id = "edit-endorsement-policy-fee-toggle")
	protected WebElement policyFeeToggle;

	// ==================== Suggested State Section Locators ====================

	@FindBy(id = "edit-endorsement-suggested-state-select")
	...
	@FindBy(xpath = "//h2[contains(text(),'Caution')]")
	...
	public EditPremiumEndorsementLocators(WebDriver driver) {
		super(driver);
	}

	/**
	 * Get element ID prefix for this page
	 */
